    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setBugInfo(response.data.bugInfoDto);
            } catch (error) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <ScrollView contentContainerStyle={styles.container}>
                ...
                {bugInfo && (
                    <View style={styles.imageWrapper}>
                        <Image source={{ uri: bugInfo.imageUrl }} resizeMode="contain" style={[styles.bugImage, { flex: 1 }]} />
                        <View style={{ flex: 1, justifyContent: 'center' }}>
                            <Text style={styles.bold14Text}>{bugInfo.title}</Text>
                            <HorizontalBlank height={15} />
                            <View style={styles.row}>
                                <Text style={styles.bold14Text}>크기</Text>
                                <VerticalBlank width={10} />
                                <Text style={styles.normal14Text}>{bugInfo.description.split('\n')[0]}</Text>
                            </View>
                            <HorizontalBlank height={15} />
                            <View style={styles.row}>
                                <Text style={styles.bold14Text}>생존 기간</Text>
                                <VerticalBlank width={10} />
                                <Text style={styles.normal14Text}>{bugInfo.description.split('\n')[1]}</Text>
                            </View>
                        </View>
